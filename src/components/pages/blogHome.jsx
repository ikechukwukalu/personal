                        ...
                        <div className="single-cat-widget">
                            <div className="content relative">
                                ...
                                <a href="#" target="_blank">
                                    <div className="thumb">
                                        <img className="content-image img-fluid d-block mx-auto" src={this.state.base_url+"assets/img/blog/cat-widget1.jpg"} alt="" />
                                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="single-cat-widget">
                            <div className="content relative">
                                ...
                                <a href="#" target="_blank">
                                    <div className="thumb">
                                        <img className="content-image img-fluid d-block mx-auto" src={this.state.base_url+"assets/img/blog/cat-widget2.jpg"} alt="" />
                                    </div>
                                    <div className="content-details">
                    ...
                    <div className="col-lg-4">
                        <div className="single-cat-widget">
                            <div className="content relative">
                                ...
                                <a href="#" target="_blank">
                                    <div className="thumb">
                                        <img className="content-image img-fluid d-block mx-auto" src={this.state.base_url+"assets/img/blog/cat-widget3.jpg"} alt="" />
                                    </div>
                                    <div className="content-details">
                ...
                <div className="row">
                    <div className="col-lg-8 posts-list">
                        <div className="single-post row">
                            ...
                            <div className="col-lg-9 col-md-9 ">
                                <div className="feature-img">
                                    <img className="img-fluid" src={this.state.base_url+"assets/img/blog/feature-img1.jpg"} alt="" />
                                </div>
                        ...
                        <div className="single-post row">
                            ...
                            <div className="col-lg-9 col-md-9 ">
                                <div className="feature-img">
                                    <img className="img-fluid" src={this.state.base_url+"assets/img/blog/feature-img2.jpg"} alt="" />
                                </div>
                        ...
                        <div className="single-post row">
                            ...
                            <div className="col-lg-9 col-md-9">
                                <div className="feature-img">
                                    <img className="img-fluid" src={this.state.base_url+"assets/img/blog/feature-img3.jpg"} alt="" />
                                </div>
                        ...
                        <div className="single-post row">
                            ...
                            <div className="col-lg-9 col-md-9">
                                <div className="feature-img">
                                    <img className="img-fluid" src={this.state.base_url+"assets/img/blog/feature-img4.jpg"} alt="" />
                                </div>
                        ...
                        <div className="single-post row">
                            ...
                            <div className="col-lg-9 col-md-9">
                                <div className="feature-img">
                                    <img className="img-fluid" src={this.state.base_url+"assets/img/blog/feature-img5.jpg"} alt="" />
                                </div>
                    ...
                    <div className="col-lg-4 sidebar-widgets">
                        <div className="widget-wrap">
                            ...
                            <div className="single-sidebar-widget user-info-widget">
                                <img src={this.state.base_url+"assets/img/blog/user-info.jpg"} alt="" />
                            ...
                            <div className="single-sidebar-widget popular-post-widget">
                                ...
                                <div className="popular-post-list">
                                    <div className="single-post-list d-flex flex-row align-items-center">
                                        <div className="thumb">
                                            <img className="img-fluid" src={this.state.base_url+"assets/img/blog/pp1.jpg"} alt="" />
                                        </div>
                                    ...
                                    <div className="single-post-list d-flex flex-row align-items-center">
                                        <div className="thumb">
                                            <img className="img-fluid" src={this.state.base_url+"assets/img/blog/pp2.jpg"} alt="" />
                                        </div>
                                        <div className="details">
                                    ...
                                    <div className="single-post-list d-flex flex-row align-items-center">
                                        <div className="thumb">
                                            <img className="img-fluid" src={this.state.base_url+"assets/img/blog/pp3.jpg"} alt="" />
                                        </div>
                                        <div className="details">
                                    ...
                                    <div className="single-post-list d-flex flex-row align-items-center">
                                        <div className="thumb">
                                            <img className="img-fluid" src={this.state.base_url+"assets/img/blog/pp4.jpg"} alt="" />
                                        </div>
                                        <div className="details">
                            ...
                            <div className="single-sidebar-widget ads-widget">
                                <a href="#"><img className="img-fluid" src={this.state.base_url+"assets/img/blog/ads-banner.jpg"} alt="" /></a>
                            </div>
