				...
				<div className="container">
					<div className="section-top-border">
						...
						<div className="row">
							<div className="col-md-3">
								<img src={this.state.base_url+"assets/img/elements/d.jpg"} alt="" className="img-fluid" />
							</div>
						...
						<div className="progress-table-wrap">
							<div className="progress-table">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f1.jpg"} alt="flag" />Canada</div>
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f2.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f3.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f4.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f5.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f6.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f7.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/img/elements/f8.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
					...
					<div className="section-top-border">
						...
						<div className="row gallery-item">
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g1.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g1.jpg)"}}></div></a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g2.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g2.jpg)"}}></div></a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g3.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g3.jpg)"}}></div></a>
							</div>
							<div className="col-md-6">
								<a href={this.state.base_url+"assets/img/elements/g4.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g4.jpg)"}}></div></a>
							</div>
							<div className="col-md-6">
								<a href={this.state.base_url+"assets/img/elements/g5.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g5.jpg)"}}></div></a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g6.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g6.jpg)"}}></div></a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g7.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g7.jpg)"}}></div></a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/img/elements/g8.jpg"} className="img-gal"><div className="single-gallery-image" style={{background: "url("+this.state.base_url+"assets/img/elements/g8.jpg)"}}></div></a>
							</div>
						</div>
					</div>
					<div className="section-top-border">
